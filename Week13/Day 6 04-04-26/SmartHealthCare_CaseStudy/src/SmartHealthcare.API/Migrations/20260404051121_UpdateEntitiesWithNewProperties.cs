        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Role", "Role IN ('Admin', 'Doctor', 'Patient')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Appointment_Status", "Status IN ('Booked', 'Completed', 'Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false, computedColumnSql: "[ConsultationFee] + [MedicineCharges]"),
                    PaymentStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bills", x => x.BillId);
                    table.CheckConstraint("CHK_PaymentStatus", "PaymentStatus IN ('Paid', 'Unpaid')");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Orthopedics", "Bones and Muscles" },
                    { 4, "Pediatrics", "Children Specialist" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedAt", "Email", "FullName", "PasswordHash", "Role" },
                values: new object[] { 1, new DateTime(2026, 4, 4, 5, 11, 21, 304, DateTimeKind.Utc).AddTicks(4178), "admin@healthcare.com", "System Admin", "$2a$11$Yc14TCUct8vd2C1ZtQD8..NAqddIIGmTuhwL9N5HsB4xErUjQPpi6", "Admin" });
